...
tasks=(
    ...
    "DenseNet-121 Internal Probability Fusion|Internal 2 Classes Calibrated/fusion_prob/result.xlsx"
    ...
    "DenseNet-121 External Early Feature Concatenation|External 2 Classes Calibrated/fusion_shared/result.xlsx"
    "DenseNet-121 External Early Feature Addition|External 2 Classes Calibrated/fusion_add_shared/result.xlsx"
    "DenseNet-121 External Late Feature Concatenation|External 2 Classes Calibrated/fusion/result.xlsx"
    "DenseNet-121 External Late Feature Addition|External 2 Classes Calibrated/fusion_add/result.xlsx"
    "DenseNet-121 External Probability Fusion|External 2 Classes Calibrated/fusion_prob/result.xlsx"
)
