...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--fold", default=0, type=int, help="fold id for cross validation  (must be 0 to 7)")
    ...
    for epoch in range(args.epochs):
        for c in range(n_center):
            epoch_log = train_fn(train_dataloader[c], model_local[c], loss_fn, optimizer_local[c], device)
